...
void nivell3()
{	
	//iniciem els boleans a la posició optima per al joc
	torna = true;
	segueix = false;
	//presentem
	presentacio3();
...
{	
	bool bo = true;
	iniciarText();//iniciem el text amb la variable creada per mi.
	NF_WriteText16(0, 0, 1, 1, "Ara be cuan el nostre amic comenca a coleccionar tresors... pero cuan acabara les seues aventures ?.. ");// i escribim el text
